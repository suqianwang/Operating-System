...
int main(int argc, char ** argv) {
    ...
    printf("The result of the init_allocator is %d bytes, which is the length of memory.\n", init_allocator(_basic_block_size, _memory_length));
    printf("Allocating 4 bytes of memory, the starting address is: %x\n", my_malloc(4));
    printf("Allocating 100 bytes of memory, the starting address is: %x\n", my_malloc(100));
    printf("Allocating 1000 bytes of memory, the starting address is: %x\n", my_malloc(1000));
    printf("Allocating 10000 bytes of memory, the starting address is: %x\n", my_malloc(10000));
